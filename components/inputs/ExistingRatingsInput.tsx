...
import { IExistingRating } from "../../interfaces/existing-rating.interface";
import styles from "./ExistingRatingsInput.module.scss";
...
export function ExistingRatingsInput({
    ...
    return (
        <>
            <table className={styles["existing-ratings-table"]}>
                ...
                <tbody>
                    ...
                    {ratings.length > 0 && (
                        <tr
                            className={`border-none border-top-3 ${styles["no-hover"]}`}>
                            <td></td>
