    ...
    return (
        <Page
            head={{
                ...
                description: "Terms and Conditions for SBC Cruncher"
            }}>
            <AccentedCard header="">
                <TermsHtml />
            </AccentedCard>
...
const TermsHtml = () => (
    <Box px={5} className="policy">
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to SBC Cruncher.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to SBC Cruncher, accessible
                    from{" "}
                    <a
                        href="https://sbccruncher.cc/"
        ...
        <ul>
            <li>
                <p>By email: contact@sbccruncher.cc</p>
            </li>
            <li>
                <p>
                    By visiting this page on our website:{" "}
                    <a
                        href="https://sbccruncher.cc/contact"
                        rel="external nofollow noopener noreferrer"
                        target="_blank">
                        https://sbccruncher.cc/contact
                    </a>
                </p>
            </li>
        </ul>
